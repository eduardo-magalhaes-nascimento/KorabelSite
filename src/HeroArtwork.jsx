...
export default function HeroArtwork() {
  return (
    <div className="artwork-panel" aria-hidden="true">
      <svg viewBox="0 0 480 520" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          ...
          >
            ...
            <stop offset="1" stopColor="#e8d5c4" />
          </linearGradient>
          <g id="flower">
        ...
        <path
          d="M113 423C96 295 122 145 230 94C318 52 382 134 372 231"
          stroke="#b8965a"
          strokeWidth=".8"
          strokeOpacity=".45"
        />
        ...
        >
          ...
          <path
            d="M236 152C244 156 251 155 256 150M236 128C240 131 244 131 247 129"
            strokeWidth="1"
          />
        </g>
        ...
        <g fill="#b8965a" fillOpacity=".18" stroke="#b8965a" strokeWidth=".6">
          <path d="M87 399C57 395 53 377 63 369C75 369 87 379 87 399ZM102 361C105 340 124 331 132 335C132 349 119 361 102 361ZM103 327C80 331 70 319 80 309C91 310 101 319 103 327ZM383 372C382 355 395 346 408 354C409 366 397 373 383 372ZM381 340C360 340 351 327 360 316C373 319 380 329 381 340Z" />
        </g>
        <g opacity=".75">
          {[
            [83, 249],
        ...
        <g
          ...
          strokeWidth="1.1"
        >
          <path d="M380 68C350 35 322 46 343 65C352 73 371 73 380 68C401 34 426 41 408 59C399 68 389 70 380 68Z" />
          <path d="M380 68C371 91 361 103 346 117L357 118L360 129C373 110 380 90 380 68ZM383 69C383 93 396 100 406 112L411 100L422 99C400 90 390 80 383 69Z" />
        </g>
        <circle
          cx="93"
          cy="447"
        ...
        <g fill="#b8965a" opacity=".55">
          <circle cx="166" cy="83" r="2" />
          <circle cx="339" cy="281" r="2" />
          <circle cx="127" cy="218" r="1.5" />
          <circle cx="369" cy="444" r="2" />
        </g>
      </svg>
